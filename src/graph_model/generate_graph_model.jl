function generate_graph_model(setup::Dict,inputs::Dict,PLANNING_OPTIMIZER::MOI.OptimizerWithAttributes,SUBPROB_OPTIMIZER::MOI.OptimizerWithAttributes)
    ...
    linking_variables_maps = Dict{Int64,Dict{VariableRef,VariableRef}}()
...
function load_planning_node!(EP::GenXModel,setup::Dict,inputs::Dict)
...
function load_operation_node!(EP::GenXModel,setup::Dict,inputs::Dict,planning_variables::Vector{VariableRef})
...
function make_linking_constraints!(graph::OptiGraph,linking_variables_maps::Dict{Int64,Dict{VariableRef,VariableRef}})
